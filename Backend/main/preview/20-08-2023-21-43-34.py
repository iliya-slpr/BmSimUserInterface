...
NODE_RANGE = 11  # the communication range of the nodes, assumin a unit disk model
...
#######lowpower and friend #####
Receive_Delay = 40  # the Receive Delay parameter in friendship mechanismb (ms)
sleep_time = 10      # the sleep time in friendship mechanism (ms)
Receive_window = 11  # the Receive window parameter in friendship mechanism( ms)
