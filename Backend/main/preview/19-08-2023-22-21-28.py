...
NODE_RANGE = 1000  # the communication range of the nodes, assumin a unit disk model
...
lowpower_Poll_interval = 110  # the request[friend poll] interval parameter in friendship mechanism (ms)
#####################
logger = []
energy_log = []
destination = []
