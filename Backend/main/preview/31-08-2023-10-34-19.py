...
ENVIRONMENT = 10  # the dimension of the environment (square) i meters that the network nodes are spread in it
##################grid deployment ############
for i17 in range(
...
#######lowpower and friend #####
Receive_Delay = 1  # the Receive Delay parameter in friendship mechanismb (ms)
sleep_time = 1      # the sleep time in friendship mechanism (ms)
...
nodes[Center_node].Heartbeat_period = 
